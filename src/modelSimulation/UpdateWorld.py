...
class InitialWorld():
    ...
    def __call__(self,minDistanceBetweenGrids,maxDistanceBerweenGrids):
        ...
        target1Grid=tuple([meshGridX[target1GridArea[0][target1GridIndex]][target1GridArea[1][target1GridIndex]],
        ...
        target2Grid=tuple([meshGridX[target2GridArea[0][target2GridIndex]][target2GridArea[1][target2GridIndex]],
